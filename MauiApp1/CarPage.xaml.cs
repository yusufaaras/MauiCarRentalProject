...
namespace MauiApp1
{
    public partial class CarPage : ContentPage
    {
        ...
        {
            Con.Open();
            string query = "select * from CarEntites";
        ...
        private void AddClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = "insert into CarEntites values('" + RegNoEntry.Text + "','" + BrandEntry.Text + "','" + ModelEntry.Text + "','" + AvailabPicker.SelectedItem.ToString() + "'," + PriceEntry.Text + ")";
        ...
        private void UpdateClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = "update CarEntites set Model='" + ModelEntry.Text + "',Price='" + PriceEntry.Text + "',Availability='"+ AvailabPicker + "',Brand='" + BrandEntry.Text+ "'where RegNo=" + RegNoEntry.Text + ";";
        ...
        private void DeleteClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = " delete  from CarEntites where RegNo='" + Convert.ToString(RegNoEntry.Text) + "';";
        ...
        private void SearchPicker_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (selectedText == "Availability")
            {
                ...
                string flag = "Yes";
                Con.Open();
                string query = "select * from CarEntites where Availability='" + flag + "'";
                SqlDataAdapter da = new SqlDataAdapter(query, Con);
