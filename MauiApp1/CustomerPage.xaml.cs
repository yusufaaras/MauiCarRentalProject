...
namespace MauiApp1
{
    public partial class CusomerPage : ContentPage
    {
        ...
        {
            Con.Open();
            string query = "select * from customerEntities";
        ...
        private void AddClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = "INSERT INTO customerEntities (CustName, CustAdd, Phone) VALUES ('" + NameEntry.Text + "','" + AddressEntry.Text + "','" + PhoneEntry.Text + "')";
        ...
        private void UpdateClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = "update customerEntities set CustName='" + NameEntry.Text + "',CustAdd='" + AddressEntry.Text + "',Phone='" + PhoneEntry.Text + "'where CustId=" + IdEntry.Text + ";";
        ...
        private void DeleteClicked(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = "DELETE FROM customerEntities WHERE CustId = @CustId";
                    SqlCommand cmd = new SqlCommand(query, Con);
